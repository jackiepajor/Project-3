...
class PrivacyPolicy extends Component {
  ...
  render() {
    return (
        <div id="content">
            <div id="main-content">
              <h3 className="display-4"><strong>Privacy Policy</strong></h3>
              <p className="policies">
              Ethan Rogers, Garvey Jackson built the Grasshopper app as an Open Source app.
              This SERVICE is provided by Ethan Rogers, Garvey Jackson at no cost and is intended 
              for use as is. <br />

              This page is used to inform website visitors regarding my policies with the collection, 
              use, and disclosure of Personal Information if anyone decided to use my Service.<br />
              ...
              which is accessible at Grasshopper unless otherwise defined in this Privacy Policy.<br />
              </p>
              <strong>Information Collection and Use</strong>
              <p className="policies">
              For a better experience, while using our Service, I may require you to provide us with certain 
              personally identifiable information, including but not limited to Email, First Name, Last Name. 
              The information that I request is retained on your device and is not collected by me in any way<br />
              ...
              <p className="policies">
                ...
                system version, the configuration of the app when utilizing my Service, the time and date of your use 
              ...
              choose to refuse our cookies, you may not be able to use some portions of this Service.<br />
              </p>
